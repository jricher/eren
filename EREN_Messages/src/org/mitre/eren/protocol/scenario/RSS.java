...
public class RSS extends BaseWrapper implements ScenarioConstants {

	public RSS(Element internal) {
		super(internal);
		// TODO Auto-generated constructor stub
	}

	public RSS(Factory factory, QName qname) {
		super(factory, qname);
		// TODO Auto-generated constructor stub
	}
	//private static Logger log = LoggingUtils.getLogger(RSS.class);
