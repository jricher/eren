 ...
 *                 &lt;attribute name="Type" type="{urn:oasis:names:tc:ciq:xpil:3}ResidencyTypeList" />
...
@XmlRootElement(name = "CountriesOfResidence")
public class CountriesOfResidence {

    @XmlElement(name = "Country", required = true)
    protected List<CountriesOfResidence.Country> country;
    @XmlAnyAttribute
     ...
     * {@link CountriesOfResidence.Country }
     * 
     * 
     */
    public List<CountriesOfResidence.Country> getCountry() {
        if (country == null) {
            country = new ArrayList<CountriesOfResidence.Country>();
        }
        return this.country;
    }
