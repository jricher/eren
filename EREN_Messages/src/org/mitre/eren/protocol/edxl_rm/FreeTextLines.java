 ...
 *       &lt;sequence>
 *         &lt;element name="FreeTextLine" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:oasis:names:tc:ciq:ct:3>String">
 *                 &lt;attGroup ref="{urn:oasis:names:tc:ciq:ct:3}grDataQuality"/>
 *                 &lt;attribute name="Type" type="{urn:oasis:names:tc:ciq:xpil:3}FreeTextLineTypeList" />
...
@XmlRootElement(name = "FreeTextLines")
public class FreeTextLines {

    @XmlElement(name = "FreeTextLine", required = true)
    protected List<FreeTextLines.FreeTextLine> freeTextLine;
    @XmlAnyAttribute
     ...
     * {@link FreeTextLines.FreeTextLine }
     * 
     * 
     */
    public List<FreeTextLines.FreeTextLine> getFreeTextLine() {
        if (freeTextLine == null) {
            freeTextLine = new ArrayList<FreeTextLines.FreeTextLine>();
        }
