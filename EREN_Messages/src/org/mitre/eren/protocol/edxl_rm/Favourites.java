 ...
 *       &lt;sequence>
 *         &lt;element name="Favourite" maxOccurs="unbounded">
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:oasis:names:tc:ciq:ct:3>String">
 *                 &lt;attGroup ref="{urn:oasis:names:tc:ciq:ct:3}grDataQuality"/>
 *                 &lt;attribute name="Type" type="{urn:oasis:names:tc:ciq:xpil:3}PersonFavouriteTypeList" />
...
public class Favourites {
    ...
    @XmlElement(name = "Favourite", required = true)
    protected List<Favourites.Favourite> favourite;
    @XmlAnyAttribute
     ...
     * {@link Favourites.Favourite }
     * 
     * 
     */
    public List<Favourites.Favourite> getFavourite() {
        if (favourite == null) {
            favourite = new ArrayList<Favourites.Favourite>();
        }
