...
public class RequestResourceDeploymentStatusWrapper extends ResourceMessageWrapper implements RequestResourceDeploymentStatus  {

  private static Logger log = LoggingUtils.getLogger(RequestResourceDeploymentStatusWrapper.class);
    

    public RequestResourceDeploymentStatusWrapper(Element internal) {
    super(internal);
    ...
    public RequestResourceDeploymentStatusWrapper(Factory factory, QName qname) {
      super(factory, qname);
      // TODO Auto-generated constructor stub
    }
