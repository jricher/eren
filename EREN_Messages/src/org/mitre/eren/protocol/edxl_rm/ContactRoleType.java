 ...
 *     &lt;enumeration value="RespondingOrg"/>
 ...
 * 
 */
@XmlType(name = "ContactRoleType", namespace = "urn:oasis:names:tc:emergency:EDXL:RM:1.0")
@XmlEnum
public enum ContactRoleType {
    ...
    REQUESTER("Requester"),
    @XmlEnumValue("SubjectMatterExpert")
    SUBJECT_MATTER_EXPERT("SubjectMatterExpert"),
    @XmlEnumValue("Approver")
    APPROVER("Approver"),
    @XmlEnumValue("RespondingOrg")
