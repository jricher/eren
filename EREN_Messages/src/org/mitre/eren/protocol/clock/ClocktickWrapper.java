...
public class ClocktickWrapper extends BaseWrapper implements ClockConstants, Clocktick {

	public ClocktickWrapper(Element internal) {
		super(internal);
	 ...
	 * @param qname
	 */
	public ClocktickWrapper(Factory factory, QName qname) {
		super(factory, qname);
		// TODO Auto-generated constructor stub
	}
